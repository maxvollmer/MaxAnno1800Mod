...
{
    class ExtraOrnamentUnlocker
    {
        public static readonly string SCOPE_BACKUP_NAME = "MaxAnno1800ModBackupScope";

        public static void UnlockExtraOrnaments(XDocument assetsXML)
        {
        ...
        public static void LockExtraOrnaments(XDocument assetsXML)
        {
        ...
        public static bool AreExtraOrnamentsInstalled(XDocument assetsXML)
        {
